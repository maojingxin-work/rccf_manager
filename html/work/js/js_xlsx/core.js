	...
	describe('comments', function() {
		if(fs.existsSync(paths.swcxlsx)) it('should have comment as part of cell properties', function(){
			...
			[wb1,wb2,wb3,wb4].map(function(wb) { return wb.Sheets[sheet]; }).forEach(function(ws, i) {
				...
				assert.equal(get_cell(ws, "B1").c[0].h, '<span style="fonts-size:8;"><b>Yegor Kozlov:</b></span><span style="fonts-size:8;"><br/>first cell</span>', "must have the html representation");
			});
		});
		[
			['xlsx', paths.cstxlsx],
